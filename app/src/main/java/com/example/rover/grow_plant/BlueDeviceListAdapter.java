...
//import com.Grow-Plant.bluetooth.le.R;
//import com.AwiseLight.bluetooth.le.iBeaconClass.iBeacon;
...
public class BlueDeviceListAdapter  extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = mInflator.inflate(R.layout.device_listitem_layout, null);
            viewHolder = new ViewHolder();
            viewHolder.deviceName = (TextView) view
                    .findViewById(R.id.device_name);
            viewHolder.customMode = (TextView) view.findViewById(R.id.customer_mode);
        ...
        viewHolder.customMode.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View arg0) {
//                Intent intent = new Intent();
//                intent.setClass(mContext, CustomModeActivity.class);
